...
//         <ChatWindow selectedForm={selectedForm}/>
//       </div>
//       </div>
//     </div>
...
//   );
  ...
  return (
    <div className="flex flex-col min-h-screen"> 
      {/* Main Section (fills screen height) */}
      <div className="flex flex-1">
        ...
        {/* Right: Chat */}
        <div className="w-[35%] bg-blackish flex flex-col">
          <div className="bg-primary text-accent text-center p-5 pt-8">
            <Link href="/">
          ...
          {/* ChatWindow */}
          <div className="flex-1 p-5 pb-2 overflow-y-auto">
            <h1 className="text-white text-2xl font-bold">Vertex AI Agent</h1>
            <ChatWindow selectedForm={selectedForm}/>
          </div>
        </div>
      ...
      <div className="bg-black w-full py-4 text-center text-white">
        © 2025 TaxEase.AI — All Rights Reserved
      </div>
    </div>
  );
